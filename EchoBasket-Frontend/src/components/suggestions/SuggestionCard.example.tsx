// src/components/suggestions/SuggestionCard.example.tsx

/**
 * EXAMPLE: Complete implementation of SuggestionCard with cart integration
 * This shows how to properly connect the card to the useCart hook
 */
...
interface SuggestionCardExampleProps {
  suggestion: Recommendation;
}

export const SuggestionCardExample: React.FC<SuggestionCardExampleProps> = ({
  suggestion,
}) => {
